<html dir="ltr" lang="es" class=""><head>
    <meta charset="utf-8">
    ...
    <!--_html_template_start_--><iron-iconset-svg size="24" name="pdf" style="display: none;">
        <svg>
            <defs>
                <!--
                These icons are copied from Polymer's iron-icons and kept in sorted order.
    ...
    <!--_html_template_end_--><!--_html_template_start_--><custom-style>
    ...
    <!--_html_template_end_--><title>Estimate_CT2006423.pdf</title></head>
<body>
...
<dom-module id="pdf-shared"><!--_html_template_start_-->
    <template>
        <style scope="pdf-shared">cr-icon-button {
            ...
            cr-action-menu, viewer-bookmark {
                --cr-menu-background-color: var(--google-grey-900);
                --cr-menu-shadow: rgba(0, 0, 0, .3) 0 1px 2px 0,
                rgba(0, 0, 0, .15) 0 3px 6px 2px;
                --cr-primary-text-color: var(--google-grey-200);
...
<dom-module id="pdf-viewer-shared-style"><!--_html_template_start_-->
    <template>
