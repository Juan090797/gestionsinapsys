<div>
    @section('cabezera-contenido')
        ...
        <h1>Editar Compra #{{$state['id']}}</h1>
    @endsection
    <div class="content-fluid">
        <form wire:submit.prevent="actualizarCompra">
            <section class="invoice p-3 mb-3" wire:ignore.self>
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($lista as $key => $producto)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input wire:change="calcularPrecio($event.target.value, {{ $key }})" type="text" class="form-control text-center" name="precio" size="5" value="{{ number_format($lista[$key]['precio_u'],2) ?? 0 }}">
                                    </td>
                                    <td class="text-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary float-right"><i class="fa fa-save mr-1"></i> Actualizar</button>
                    </div>
                </div>
            </section>
        </form>
