                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($rows as $key => $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input wire:change="calculatePrice($event.target.value, {{ $key }})" type="text" class="form-control text-center" name="precio" size="5" value="{{ $rows[$key]['precio_u'] }}">
                                    </td>
                                    <td class="text-center">
                                        <input type="text" class="form-control text-center" name="monto" value="{{ $rows[$key]['precio_t'] }}" size="5" disabled>
                                    </td>
                                    <td class="text-center">
